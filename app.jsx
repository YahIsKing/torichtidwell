...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Betrothing women before 20 wasn't a fringe practice — it was **even MORE widespread than polygyny**. If this practice were sinful, if it made men perverts and pedophiles as your framework implies, **where is the rebuke?**" },
      { type: "h2", text: "Roman Law Makes This Even Worse for You" },
      { type: "p", text: "Here's what makes your position completely untenable. Roman legal norms set standards for citizens throughout the empire, while Judean communities retained their own marriage customs under Roman rule. Consider what Roman law said about these two issues:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "On marriage age: Torah specifies no minimum age. Jewish practice was to marry before 20. Roman law permitted marriage at 12. Jesus said nothing. The apostles said nothing. **And yet you reject the unanimous witness of Torah's silence, Jewish practice, Roman law, AND apostolic silence to invent a standard that appears nowhere?**" },
      ...
      { type: "p", text: "But here's what you're missing: Ancient Israel achieved that population growth through polygyny **AND** through marrying women before 20 — not at age 20. The same practices you celebrate as \"good fruit\" included the very thing you now condemn as perversion. **You're celebrating the fruit while condemning half the tree that produced it.**" },
      ...
      { type: "p", text: "The meaning of hyperakmos in this passage is genuinely debated among scholars — some argue it refers to the woman being 'past her prime/bloom of youth,' while others argue it refers to the man being 'full of passion.' **But here's what matters: regardless of which interpretation you hold, Paul does not state a numerical age like '20.'** He had the perfect opportunity to be specific. He wasn't." },
      { type: "p", text: "Contemporary medical writers provide useful background on ancient views of puberty and marriage readiness. **Soranus of Ephesus** was a Greek physician practicing in Rome during the reigns of Trajan and Hadrian (~98-138 AD) — a direct contemporary of the apostolic era. His *Gynecology* was the authoritative medical text on women's health for 1,500 years. In his chapter titled \"Up to What Time Females Should Be Kept Virgins,\" Soranus writes:" },
      ...
      { type: "p", text: "Rich, this is a Greek physician **contemporary with Paul** discussing puberty timing and sexual readiness in the mid-teens — not age 20. This provides important cultural context: ancient medical writers were concerned with physical maturity and readiness, not an arbitrary age-20 threshold." },
      { type: "p", text: "**The key point stands regardless of the hyperakmos debate:** Moses didn't say it. The prophets didn't say it. Christ didn't say it. And now we see that Paul — directly addressing the question of when a father should give his daughter in marriage — didn't say it either. He used a term referring to maturity or readiness, not a specific age. He could have said 'age 20' if that was the standard. He didn't. The Holy Spirit, inspiring Paul's pen, chose hyperakmos — not 'age 20.'" },
      ...
      { type: "p", text: "Brother, I'm not trying to be harsh here. I'm asking you to honestly consider: if this requirement were as clear and important as you make it out to be, why did God leave it for you to piece together? Why didn't Moses just say it? Why didn't any prophet, apostle, or Christ Himself simply state it? And one last thing to consider: if the practice of marrying before 20 was as widespread as the historical evidence shows — and it was — why didn't anyone correct anyone? Not once. Not ever." },
      { type: "p", text: "Remember your own argument: \"Why isn't there a protocol in the New Testament?\" The practice was common, there's no protocol correcting it, therefore it remains lawful. That's YOUR logic for polygyny. Apply it here — marriage before 20 was even MORE common, and there's no protocol correcting it either. Your silence argument proves marriage before 20 lawful with even greater force than it proves polygyny." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "You know exactly why you need Mary to be over 20. If the mother of our Messiah was betrothed before 20 — as was normal Jewish practice — your entire \"age 20\" framework collapses. So you're forced into this desperate, illogical argument: using a male-only Torah census requirement to interpret a Roman census to prove a woman's age meets a standard that exists in neither legal system." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "As I covered in detail earlier ([Section 17](#section-17)), you hold up ancient Israel's population growth as **good fruit** — but that growth came through polygyny AND marrying women before 20. **You're celebrating the fruit while condemning half the tree that produced it.**" },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "We're not your enemies. We're brothers who want to see you succeed. But we can't stand by silently while you bind burdens on people that Torah does not bind — and falsely accuse brothers and sisters in Christ of being perverts for marrying at 18 or 19 years old — **the very thing you rightly criticize others for doing to you on polygyny.**" }
    ],
  ...
  },
  {
    ...
    content: [
      ...
      { type: "ul", items: [
        ...
        "**The Category Error** — You quote Romans 7:2 about \"married women\" (*hypandros*) but apply it to divorced women who are NOT under a husband.",
      ...
      { type: "ul", items: [
        ...
        "**Your Linguistic Argument Fails** — Deut 22:24 calls the na'ara his \"wife\" (אֵשֶׁת). Your ʾîš/ʾiššâ argument self-destructs.",
        ...
        "**Your Own Argument Condemns You** — Silence on polygyny = permitted. Silence on marriage before 20 = forbidden? Apply your own standard.",
        "**The Mary Problem** — Your census argument fails. It was a ROMAN census (age 12 minimum), not Num 26:4. If Mary was under 20, your framework makes Joseph guilty and God complicit.",
        "**The False Witness** — You call men \"pedophiles\" for marrying legal adults who broke no law.",
        "**The Loophole** — Your framework leaves 18-19 year olds unprotected by Exodus 22:16-17. Predators walk free.",
...
const closing = {
  paragraphs: [
    ...
    "Rich, on November 23rd I sent you that message in love: \"I feel strongly to encourage you to slow down... be careful that you are not adding to His word and commands in the positions you are taking.\" You responded warmly: \"I appreciate your friendship, hopefully we can meet in person!\" Two weeks later, you removed me from your Instagram group. Two days after that, you went back and removed me as a collaborator on a photo of your newborn daughter. I didn't change. My heart didn't change. My message didn't change. What changed is that I followed through — I showed you WHERE you were adding to His word. And instead of engaging, you erased me. That's not iron sharpening iron, Rich. That's a warning sign.",
